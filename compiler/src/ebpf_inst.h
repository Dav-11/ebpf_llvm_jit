...
#define EBPF_OP_MOV_REG (EBPF_CLS_ALU | EBPF_SRC_REG | 0xb0)   // bf
...
#define EBPF_OP_LDXW (EBPF_CLS_LDX | EBPF_MODE_MEM | EBPF_SIZE_W) // 61
...
// macro for IFs
#define GET_CLASS(opcode) (opcode & EBPF_CLS_MASK)
#define IS_LOAD(opcode) (GET_CLASS(opcode) == EBPF_CLS_LD || GET_CLASS(opcode) == EBPF_CLS_LDX)
#define GET_LOAD_MODE(opcode) (opcode & EBPF_LD_MODE_MASK)
#define IS_LOAD_FROM_MEM(opcode) (IS_LOAD(opcode) || GET_LOAD_MODE(opcode) == 0x60)
